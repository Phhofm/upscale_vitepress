<template>
    ...
    <image-compare v-if="nondraggable" :before="before" :after="after" isZoomable :key="componentKey" :zoom="zoom"
      @wheel.prevent @touchmove.prevent @scroll.prevent />
  
    <image-compare v-if="!nondraggable" :before="before" :after="after" isDraggable isZoomable :key="componentKey"
      :zoom="zoom" @wheel.prevent @touchmove.prevent @scroll.prevent />
